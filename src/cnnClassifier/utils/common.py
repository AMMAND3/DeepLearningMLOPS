...
# Reason for importing box ConfigBox - ease of use. Say we have:
...
# ensure annotation helps here since we make debug code easily based on type parameters for function define. So here, if path_to_yaml is not of Path type, we SHOULD get error
@ensure_annotations
